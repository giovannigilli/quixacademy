...
// import it.quix.experis.quixacademy.core.handler.OggettiHandler;
 ...
 */
public class OggettiAbstractManagerAction extends QuixacademyManagerAction {
    ...
    public String list() throws QuixacademyException {
        try {
            ...
            getQuixacademyManager().validateOggettiSearch(oggettiSearch);
            // Perform count of record that satisfy search filters
            long total = getQuixacademyManager().countOggetti(oggettiSearch);
            // If there are results ...
            List<Oggetti> oggettiList = null;
            if (total > 0) {
                // Search the results to display
                do {
                    oggettiList = getQuixacademyManager().getOggettiList(oggettiSearch);
    ...
    public String exportXls() throws Exception {
        ...
        List<Oggetti> oggettiList = getQuixacademyManager().getOggettiList(oggettiSearch);
        long countOggetti = getQuixacademyManager().countOggetti(oggettiSearch);
        ...
        ExcelComposer c = new ExcelComposer() {
            ...
            protected Object translate(Field field, Object value) {
                if (field.getName().equals("proprietario")) {
                    String stringValue = "";
                    Soggetti proprietario = (Soggetti) value;
    ...
    public String edit() {
        ...
        try {
            oggetti = getQuixacademyManager().getOggetti(oggetti.getId());
    ...
    public String save() {
        ...
        try {
            getQuixacademyManager().saveOggetti(oggetti);
    ...
    public String delete() {
        try {
            getQuixacademyManager().deleteOggetti(oggetti.getId());
            return manageOkMessage();
        } catch (Exception e) {
