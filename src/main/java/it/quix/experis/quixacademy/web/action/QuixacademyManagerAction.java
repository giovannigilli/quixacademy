package it.quix.experis.quixacademy.web.action;
...
public abstract class QuixacademyManagerAction extends QuixActionSupport {
    ...
    private static final Log log = LogFactory.getLog(QuixacademyManagerAction.class);
    ...
    private String getExceptionParameter(Exception e, String message) {
        ...
        sb.append(" ");
        while (i < QuixacademyManagerAction.MAX_EXCEPTION_CAUSEDBY) {
    ...
    public QuixacademyUserContext getUserContext() {
        return (QuixacademyUserContext) super.getUserContext();
    }
