...
// import it.quix.experis.quixacademy.core.handler.SoggettiHandler;
 ...
 */
public class SoggettiAbstractManagerAction extends QuixacademyManagerAction {
    ...
    public String list() throws QuixacademyException {
        try {
            ...
            getQuixacademyManager().validateSoggettiSearch(soggettiSearch);
            // Perform count of record that satisfy search filters
            long total = getQuixacademyManager().countSoggetti(soggettiSearch);
            // If there are results ...
            List<Soggetti> soggettiList = null;
            if (total > 0) {
                // Search the results to display
                do {
                    soggettiList = getQuixacademyManager().getSoggettiList(soggettiSearch);
    ...
    public String exportXls() throws Exception {
        ...
        List<Soggetti> soggettiList = getQuixacademyManager().getSoggettiList(soggettiSearch);
        long countSoggetti = getQuixacademyManager().countSoggetti(soggettiSearch);
    ...
    public String edit() {
        ...
        try {
            soggetti = getQuixacademyManager().getSoggetti(soggetti.getUsername());
    ...
    public String save() {
        ...
        try {
            getQuixacademyManager().saveSoggetti(soggetti);
    ...
    public String delete() {
        try {
            getQuixacademyManager().deleteSoggetti(soggetti.getUsername());
            return manageOkMessage();
        } catch (Exception e) {
