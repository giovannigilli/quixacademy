	...
	<div class="box box-framework" >
		...
		<div class="box-body">
			...
			<div class="qrow">		
				...
				<div class="qcol-md-6 qcol-sm-6 qcol-xs-12" ng-class="{'qhas-error': forms.oggettiEditForm.prestito.$invalid}">
					<label for="prestito"><s:text name="oggetti.edit.prestito"/></label>
					<input type="text" 
						ng-model="scopeController.selectedRow.prestito" 
						id="prestito" 
						name="prestito"
						class="qform-control" />
					<div ng-messages="forms.oggettiEditForm.prestito.$error" role="alert">
					  	<div ng-message="notNull"><s:text name="error.notNull"/></div>
					  	<div ng-message="invalidAK"><s:text name="error.invalidAK"/></div>
					  	<div ng-message="notValid"><s:text name="error.notValid"/></div>
					  	<div ng-message="lenght"><s:text name="error.lenght"/></div>
