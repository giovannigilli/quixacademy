...
<s:url id="checkUrl" action="home" escapeAmp="false">
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/scripts/qxQuixacademyCommonsComponent.js?_<jsp:include page='_version.jsp' />"></script>
	<script type="text/javascript" src="<%=request.getContextPath() %>/scripts/service/qxQuixacademyHttpService.js?_<jsp:include page='_version.jsp' />"></script>
	...
	<script type="text/javascript">
		...
		var module = angular.module('quixacademy');
		module.constant('quixacademyConfig', {
