package it.quix.experis.quixacademy;
...
public class BaseTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        try {
            String[] contextFileNames = { "quixacademy-test-spring.xml" };
            ...
            QuixacademyUserContext uc = new QuixacademyUserContext();
            it.quix.framework.core.manager.UserContextHolder.setUserContext(uc);

            ManagerHolder.setManagerOnThreadLocal("quixacademyManager", applicationContext.getBean("quixacademyManager"));
