...
var qxQuixacademyHttpService = function($http, quixacademyConfig, $timeout) {
	...
	function _getOggettiList(scopeController, form) {
        ...
        scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/oggetti.action?task=list&reset=true', 
    ...
    this.editOggetti = function(scopeController){
        ...
        scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/oggetti.action?task=edit', 
     ...
     this.deleteOggetti = function(scopeController, labelService){
        ...
        scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/oggetti.action?task=delete', 
        		data: quixParamSerializer(scopeController.selectedRow, 'oggetti.'), 
        		headers: {'Content-Type': 'application/x-www-form-urlencoded'}
        });
        scopeController.promise.success(success).error(_manageError);
    ...
    this.saveOggetti = function(scopeController, form) {
        ...
        scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/oggetti.action?task=save&reset=true', 
        		data: quixParamSerializer(scopeController.selectedRow, 'oggetti.'), 
        		headers: {'Content-Type': 'application/x-www-form-urlencoded'}
        });
        scopeController.promise.success(success).error(_manageError);
	...
	function _getPrestitiList(scopeController, form) {
        ...
        scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/prestiti.action?task=list&reset=true', 
    ...
    this.editPrestiti = function(scopeController){
        ...
        scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/prestiti.action?task=edit', 
     ...
     this.deletePrestiti = function(scopeController, labelService){
        ...
        scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/prestiti.action?task=delete', 
        		data: quixParamSerializer(scopeController.selectedRow, 'prestiti.'), 
        		headers: {'Content-Type': 'application/x-www-form-urlencoded'}
        });
        scopeController.promise.success(success).error(_manageError);
    ...
    this.savePrestiti = function(scopeController, form) {
        ...
        scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/prestiti.action?task=save&reset=true', 
        		data: quixParamSerializer(scopeController.selectedRow, 'prestiti.'), 
        		headers: {'Content-Type': 'application/x-www-form-urlencoded'}
        });
        scopeController.promise.success(success).error(_manageError);
	...
	function _getSoggettiList(scopeController, form) {
        ...
        scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/soggetti.action?task=list&reset=true', 
    ...
    this.editSoggetti = function(scopeController){
        ...
        scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/soggetti.action?task=edit', 
     ...
     this.deleteSoggetti = function(scopeController, labelService){
        ...
        scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/soggetti.action?task=delete', 
        		data: quixParamSerializer(scopeController.selectedRow, 'soggetti.'), 
        		headers: {'Content-Type': 'application/x-www-form-urlencoded'}
        });
        scopeController.promise.success(success).error(_manageError);
    ...
    this.saveSoggetti = function(scopeController, form) {
        ...
        scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/soggetti.action?task=save&reset=true', 
        		data: quixParamSerializer(scopeController.selectedRow, 'soggetti.'), 
        		headers: {'Content-Type': 'application/x-www-form-urlencoded'}
        });
        scopeController.promise.success(success).error(_manageError);
	...
	this.getCombo = function(scopeController, name){
    	var success = function (data) {
    	 ...
    	 scopeController.promise = $http({ 
        		method: 'POST', 
        		url: quixacademyConfig.baseUrl + '/'+name+'.action?task=list&reset=true&'+name+'Search.page=-1', 
        		headers: {'Content-Type': 'application/x-www-form-urlencoded'}
        });
        scopeController.promise.success(success).error(_manageError);
    }					
...
quixacademyApp.service('qxQuixacademyHttpService', ['$http', 'quixacademyConfig', '$timeout', qxQuixacademyHttpService]);								
