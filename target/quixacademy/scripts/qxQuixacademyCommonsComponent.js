if(typeof quixacademyPresent == 'undefined'){
    ...
    var quixacademyApp = angular.module('quixacademy', dependencyArray);
    ...
    quixacademyApp.run(["$templateCache", function($templateCache) {
